...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("xvrenyog")

  // remove
  collection.schema.removeField("fvbambme")

  // remove
  collection.schema.removeField("2lbatavq")

  // remove
  collection.schema.removeField("ckvwgi9r")

  // remove
  collection.schema.removeField("elmn5lkw")

  // remove
  collection.schema.removeField("5lldj5my")

  // remove
  collection.schema.removeField("pkfo2s1s")

  // remove
  collection.schema.removeField("fpkhme0y")
